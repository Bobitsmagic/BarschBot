...
impl CheckPinMask {
    pub fn pins_on(color: PlayerColor, board: &BitBoard) -> CheckPinMask {
        ...
        let diagonal_attackers =
            board.diagonal_slider & opposing_pieces & DIAGONAL_MOVES[king_square as usize];
        ...
        let orhtogonal_attacker =
            board.orthogonal_slider & opposing_pieces & ORTHOGONAL_MOVES[king_square as usize];
