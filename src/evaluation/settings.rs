use crate::{evaluation::{hans_eval::{self, Attributes}, wiesel_eval::{self, WieselSettings}}, game::game_state::{self, GameState}};
...
impl Settings {
    pub fn evaluate(&self, game_state: &GameState) -> i32 {
        return match self.evaluation_mode {
            EvaluationMode::HansEvaluation(attr) => hans_eval::evaluation_function(game_state, &attr),
